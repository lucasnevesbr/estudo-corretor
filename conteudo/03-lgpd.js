...
window.CONTEUDO["lgpd"] = {
  ...
  simulado: [
    ...
    {id:"q5", peso:"alto",
     ...
     alts:["A corretora é operadora e a empresa de tecnologia é controladora.","Ambas são controladoras, pois compartilham a base.","A corretora é controladora e a empresa de tecnologia é operadora.","Não há tratamento de dados, pois a hospedagem é mero armazenamento."],
     correta:2,
    ...
    {id:"q6", peso:"alto",
     ...
     alts:["Onerosidade do acesso.","Necessidade.","Prevenção.","Não discriminação."],
     correta:0,
    ...
    {id:"q7", peso:"medio",
     ...
     alts:["Todos os dados devem ser imediatamente eliminados, sem exceção.","A corretora pode conservar os dados amparados em outra base legal, como obrigação legal ou regulatória.","Os tratamentos realizados antes da revogação tornam-se ilícitos retroativamente.","A revogação só produz efeitos após 15 dias e mediante pagamento de taxa administrativa."],
     correta:1,
    ...
    {id:"q8", peso:"medio",
     ...
     alts:["Deve obrigatoriamente ser advogado inscrito na Ordem dos Advogados do Brasil.","É indicado pela ANPD para fiscalizar o controlador.","Sua indicação é obrigatória para todos os controladores, sem qualquer exceção.","Atua como canal de comunicação entre o controlador, os titulares e a ANPD, e sua identidade e contato devem ser divulgados publicamente."],
     correta:3,
    ...
    {id:"q9", peso:"medio",
     ...
     alts:["Não há dever de comunicar, bastando registrar internamente o ocorrido.","O controlador deve comunicar à ANPD e ao titular, e a autoridade pode determinar ampla divulgação do fato.","A comunicação é devida apenas ao Ministério Público.","A obrigação de comunicar recai exclusivamente sobre o operador."],
     correta:1,
    ...
    {id:"q11", peso:"alto",
     ...
     alts:["Finalidade.","Segurança.","Qualidade dos dados.","Livre acesso."],
     correta:0,
    ...
    {id:"q12", peso:"medio",
     ...
     alts:["Por empresa estrangeira que oferta serviços a pessoas localizadas no Brasil.","Por corretora de seguros sediada no Brasil.","Por pessoa natural para fins exclusivamente particulares e não econômicos.","Por controlador que armazena os dados em servidor fora do país."],
     correta:2,
    ...
    {id:"q14", peso:"medio",
     ...
     alts:["Órgão da administração pública federal integrante da Presidência da República, sem autonomia.","Autarquia de natureza especial, dotada de autonomia técnica e decisória.","Entidade privada de autorregulação do setor.","Conselho vinculado ao Ministério da Justiça, sem poder sancionatório."],
     correta:1,
