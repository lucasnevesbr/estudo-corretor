...
window.CONTEUDO["matematica"] = {
  ...
  simulado: [
    ...
    {id:"q2", peso:"alto",
     ...
     alts:["R$ 1.200,00 e R$ 200,00","R$ 1.100,00 e R$ 100,00","R$ 1.210,00 e R$ 210,00","R$ 1.221,00 e R$ 221,00"],
     correta:2,
    ...
    {id:"q3", peso:"alto",
     ...
     alts:["O montante em juros compostos é maior.","Os montantes são sempre iguais.","A comparação é impossível sem conhecer o capital.","O montante em juros simples é maior."],
     correta:3,
    ...
    {id:"q4", peso:"alto",
     ...
     alts:["1,39% ao mês","1,50% ao mês","0,15% ao mês","2,25% ao mês"],
     correta:1,
    ...
    {id:"q5", peso:"alto",
     ...
     alts:["10,50% ao semestre","21,00% ao semestre","10,00% ao semestre","11,00% ao semestre"],
     correta:2,
    ...
    {id:"q6", peso:"alto",
     ...
     alts:["2,00% ao mês e 26,82% ao ano","2,00% ao mês e 24,00% ao ano","1,81% ao mês e 24,00% ao ano","2,24% ao mês e 26,82% ao ano"],
     correta:0,
    ...
    {id:"q8", peso:"alto",
     ...
     alts:["O desconto racional é maior, e por isso é o preferido pelos bancos.","Os dois descontos são sempre iguais, mudando apenas o nome.","O desconto comercial é maior apenas quando o prazo excede 12 meses.","O desconto comercial é maior, e o valor atual resultante é menor."],
     correta:3,
    ...
    {id:"q9", peso:"alto",
     ...
     alts:["R$ 4.500,00","R$ 5.000,00","R$ 7.200,00","R$ 5.400,00"],
     correta:1,
    ...
    {id:"q10", peso:"alto",
     ...
     alts:["2 anos","4 anos","3 anos e 6 meses","3 anos"],
     correta:3,
    ...
    {id:"q11", peso:"medio",
     ...
     alts:["A primeira parcela é paga no início do primeiro período, no instante zero.","O devedor quita as parcelas antes do vencimento contratado.","As parcelas sofrem correção monetária no início de cada ano.","O prazo total da série é inferior a doze meses."],
     correta:0,
    ...
    {id:"q12", peso:"medio",
     ...
     alts:["Da postecipada é maior que o da antecipada.","É igual nas duas, pois as parcelas são iguais.","Da antecipada é maior que o da postecipada.","Depende exclusivamente do número de parcelas."],
     correta:2,
    ...
    {id:"q15", peso:"medio",
     ...
     alts:["O prêmio fracionado equivale financeiramente ao prêmio à vista, pois a soma das parcelas é idêntica.","O fracionamento é vedado pela regulamentação, que exige pagamento único do prêmio.","O fracionamento configura uma série de pagamentos, e a diferença em relação ao prêmio à vista tem natureza de juros, devendo o custo ser informado ao segurado.","O custo do fracionamento é suportado integralmente pelo corretor de seguros."],
     correta:2,
