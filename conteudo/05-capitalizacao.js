...
window.CONTEUDO["capitalizacao"] = {
  ...
  simulado: [
    {id:"q1", peso:"alto",
     ...
     alts:["Quota de capitalização, quota de sorteio e quota de carregamento.","Quota de risco, quota de sorteio e quota de resgate.","Quota de prêmio, quota de comissão e quota de reserva.","Quota de poupança, quota de administração e quota de contingência."],
     correta:0,
    ...
    {id:"q2", peso:"alto",
     ...
     alts:["70% desde o primeiro pagamento, sem exceção.","50% em todos os meses de vigência.","10% nos três primeiros meses e 70% a partir do quarto mês, com média de no mínimo 70% até o fim da vigência.","Livremente definido pela sociedade na nota técnica atuarial."],
     correta:2,
    ...
    {id:"q9", peso:"alto",
     ...
     alts:["O título rende mais que a poupança por determinação normativa.","No título, parte do pagamento é destinada a sorteio e carregamento e não retorna ao titular, além de poder haver carência para resgate.","A poupança, ao contrário do título, está sujeita à fiscalização da SUSEP.","O título é isento de qualquer prazo de carência, como a poupança."],
     correta:1,
    ...
    {id:"q10", peso:"medio",
     ...
     alts:["Sorteios a Realizar.","Despesas Administrativas.","Resgates.","Sorteios a Pagar."],
     correta:3,
    ...
    {id:"q11", peso:"alto",
     ...
     alts:["R$ 1.400,00.","R$ 2.000,00.","R$ 600,00.","R$ 1.000,00."],
     correta:0,
    ...
    {id:"q12", peso:"medio",
     ...
     alts:["Recebe o capital ao final e doa apenas os prêmios eventualmente sorteados.","Não tem direito a sorteio, apenas ao resgate integral.","Cede o direito de resgate a entidade beneficente certificada, permanecendo com o direito de concorrer aos sorteios.","Contrata o título em nome de empresa promotora de evento comercial."],
     correta:2,
    ...
    {id:"q13", peso:"medio",
     ...
     alts:["Decreto-Lei 73, de 1966.","Código Civil, artigos 757 a 802.","Lei 4.594, de 1964.","Decreto-Lei 261, de 1967."],
     correta:3,
    ...
    {id:"q14", peso:"alto",
     ...
     alts:["É modalidade de seguro, pois há transferência de risco à sociedade emissora.","É contrato de constituição de capital, restituível nos termos pactuados, com direito a concorrer a sorteios.","É título de crédito ao portador, negociável em bolsa.","É aplicação financeira de renda fixa, com rentabilidade garantida por lei."],
     correta:1,
    ...
    {id:"q15", peso:"alto",
     ...
     alts:["Somar o índice do período à taxa de juros acumulada e aplicar o total sobre o valor pago.","Aplicar apenas a taxa de juros, pois ela já embute a inflação.","Atualizar o capital pelo índice e, sobre o valor atualizado, aplicar a taxa de juros real.","Aplicar apenas o índice de atualização, pois a taxa real é meramente referencial."],
     correta:2,
